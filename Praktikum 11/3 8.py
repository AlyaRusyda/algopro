...
my_app = tk.Tk()
my_app.title("Kalkulator Luas Persegi")

main_frame = tk.Frame(master=my_app, padx=20, pady=20)
main_frame.grid(column=0, row=0)

Font_style = ("Arial", 20, "bold")
tk.Label(master=main_frame, text='Kalkulator Luas Persegi', font=Font_style).grid(column=0, row=0, columnspan=2, pady=(0, 20))

tk.Label(master=main_frame, text='Sisi', font='Arial 12').grid(column=0, row=1, sticky="w", pady=5)
sisi = StringVar()
